    ...
    useEffect(() => {
        ...
        fetch(apiUrl)
            ...
            .then((data) => {
                ...
                sevenDaysAgo.setDate(sevenDaysAgo.getDate() - 70);
        ...
        <div>
            <div className="bg-blue-900 text-center py-4 lg:px-4">
                <div className="p-2 bg-blue-800 items-center text-blue-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                    ...
                    <Link to={`/nouvelle-page/${articleSlug}`} className="font-semibold mr-2 text-left flex-auto">Nouvelle Article : {articleName}</Link>
